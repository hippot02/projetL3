 ...
 */
final class Version20221113173706 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE accueil ADD active TINYINT(1) NOT NULL, ADD title VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE upload_user (upload_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_9175130CCCFBA31 (upload_id), INDEX IDX_9175130A76ED395 (user_id), PRIMARY KEY(upload_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE accueil DROP active, DROP title');
    }
}
